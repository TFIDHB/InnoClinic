...
namespace InnoClinic.Appointments.Controllers
{
    ...
    public class AppointmentController(IAppointmentService appointmentService) : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<ActionResult<IEnumerable<AppointmentSlotDto>>> GetAppointmentSlots([FromQuery] DateOnly date, [FromQuery] Guid? doctorId, CancellationToken ct = default)
        {
