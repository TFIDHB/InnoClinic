...
{
    public class CreateMyPatientProfileRequestDtoValidator : AbstractValidator<CreateMyPatientProfileRequestDto>
    {
        public CreateMyPatientProfileRequestDtoValidator()
        {
